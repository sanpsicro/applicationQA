...
$explota_modulos=explode(",",$_SESSION["valid_modulos"]);
                ...
                <?php 
                    ...
                    <li class="dropdown">
          <a href="#" class="dropdown-toggle menunw fonter" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MEN� <span class="caret"></span></a>
          <ul class="dropdown-menu">
<?php	
					if(array_search("capacitacion",$explota_modulos)!==FALSE) { ?>
						<li><a href="?module=capacitacion" class="menunw2">ORGANIZACI�N</a></li>
