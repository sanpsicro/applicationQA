...
$result = mysqli_query("SELECT * FROM recordatorios where visto=0 and empleado=$valid_userid and privacidad=1 and hora<CONVERT_TZ(now(),'+00:00','+02:00') order by hora ASC LIMIT 1", $link); 
