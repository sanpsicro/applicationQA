...
<form id="form1" name="form1" method="post" action="process.php?module=usuariox&id=<? echo $id;?>">
  <table width="100%" border="0" cellspacing="3" cellpadding="3">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="reporta" type="text" id="reporta" size="30" value="<? echo $reporta;?>"/></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="email" type="text" id="cobertura" size="30" value="<? echo $email;?>"/></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>  
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td>
