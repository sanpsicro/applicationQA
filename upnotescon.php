...
mysqli_query($link,"INSERT INTO `clientacora` (`general`, `usuario`, `fecha`, `comentario`, `tipo`, `visto`, `num_poliza`) VALUES ('$id', '$valid_userid', CONVERT_TZ(now(),'+00:00','+02:00'), '$comentario', '1', '0', '$num_poliza')") or die(mysqli_error($link)); 
