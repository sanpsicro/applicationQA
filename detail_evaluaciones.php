...
<table width="100%%" border="0" cellspacing="3" cellpadding="3">
  ...
  <tr>
    ...
    <td width="25%" bgcolor="#FFFFFF"><? echo $id; ?> [<a href="mainframe.php?module=detail_seguimiento&id=<? echo $id; ?>" target="_blank">VER EXPEDIENTE</a>]</td>
  </tr>
  <tr>

    <td width="25%" bgcolor="#eeeeee"><strong>Servicio:</strong></td>
    <td width="25%" bgcolor="#eeeeee"><? echo $service; ?> </td>
  </tr>  
  <tr>

    <td width="25%" bgcolor="#FFFFFF"><strong>Proveedor:</strong></td>
    <td width="25%" bgcolor="#FFFFFF"><? echo $proverbio; ?> </td>
  </tr>  
  ...
  <tr>
    ...
    <tr>
    <td bgcolor="#FFFFFF"><strong>En base al servicio de asistencia recibido, &iquest; Usted compraría nuevamente su seguro ?:</strong></td>
    <td bgcolor="#FFFFFF"><? echo $renovaria; ?></td>
  </tr>
  <tr>
