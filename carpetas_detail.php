...
isset($_GET['capid']) ? $par= $_GET['par'] : $par= null ;	
isset($_GET['par']) ? $capid = $_GET['capid'] : $capid = null ;	
isset($_GET['main']) ? $main= $_GET['main'] : $main= null ;	
isset($_GET['bm']) ? $bm= $_GET['bm'] : $bm= null ;	
