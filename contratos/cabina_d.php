...
<table border=0 width=100% cellpadding=0 cellspacing=0>
 ...
 <tr>
   <td align="left"><form id="form1" name="form1" method="post" action="process.php?module=cabina_d&idcaso=<? echo $idcaso;?>&accela=new">
     ...
     <table width="100%%" border="0" cellpadding="3" cellspacing="3">
       ...
       <tr>
         <td colspan="6" align="center" bgcolor="#CCCCCC"><input type="submit" name="Submit" value="C O N C L U I R   A L T A   D E   S E R V I C I O" />
           &nbsp;
           <input type="button" name="button2" id="button2" value="C A N C E L A R   S E R V I C I O" onClick="javascript:confirmcancel('process.php?module=cabina_d&accela=cancelar&idcaso=<? echo $idcaso; ?>');" onMouseover="window.status=''; return true;"/></td>
         </tr>
     </table>
      </form>
   </td>
