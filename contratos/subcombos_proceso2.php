...
$result = mysql_query("SELECT * FROM Municipio where idEstado='$_GET[opcion]' order by NombreMunicipio", $link); 
...
$result = mysql_query("SELECT * FROM Colonia where idMunicipio='$_GET[opcion]' order by NombreColonia", $link); 
...

{
	...
	$consulta=mysql_query("SELECT * FROM Municipio WHERE idEstado='$opcionSeleccionada'") or die(mysql_error());
