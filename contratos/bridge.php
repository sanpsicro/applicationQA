...
if( (isset($_POST[clave_usuario]) or isset($_POST[nombre]) or isset($_POST[placas])) && isset($_GET[module]) && $_GET[module]=="cabina"){header("Location: mainframe.php?module=$_GET[module]&clave_usuario=$_POST[clave_usuario]&nombre=$_POST[nombre]&placas=$_POST[placas]");}
