...
$checa_array1=array_search("tecnico_solicitado",$campos); if($checa_array1===FALSE){} else{echo'<td align="center" bgcolor="#bbbbbb"><strong>T�cnico solicitado</strong></td>';}
