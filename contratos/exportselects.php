  ...
  <tr>
    <td>
        <select name="tablax" id="tablax" onChange="FAjax('export_combo.php?&flim-flam=new Date().getTime()','dry','tablax='+document.getElementById('tablax').value,'POST')" >
          ...
          <option value="Empleado" <? if($tablax=="Empleado"){echo"selected";}?>>Usuarios</option>
          <option value="Cliente" <? if($tablax=="Cliente"){echo"selected";}?>>Clientes</option>
          <option value="Poliza" <? if($tablax=="Poliza"){echo"selected";}?>>Contratos</option>
          <option value="validaciones" <? if($tablax=="validaciones"){echo"selected";}?>>Validaciones</option>                                          
          <option value="proveedores" <? if($tablax=="proveedores"){echo"selected";}?>>Proveedores</option>                                                
          <option value="ventas" <? if($tablax=="ventas"){echo"selected";}?>>Ventas</option>          
          <option value="general" <? if($tablax=="general"){echo"selected";}?>>Seguimiento</option>                
          <option value="pagos" <? if($tablax=="pagos"){echo"selected";}?>>Control de Pagos</option>   
		  <option value="cobranza" <? if($tablax=="cobranza"){echo"selected";}?>>Control de Cobranza</option> 		  		  <option value="combinado" <? if($tablax=="combinado"){echo"selected";}?>>Control de Pago/Cobranza</option>
...
if($tablax=="ventas"){
	...
	echo'<td>
			...
			<tr>
				<td valign=top>
					<input name="campos[]" type="checkbox" value="nombre"'.checkradioarr("nombre",$campos).'/> Cliente<br>
	...
	<b>Ordenar por:</b><br>
	<select name="sort" id="sort">';
	echo'<option value="nombre"'.($sort=="nombre"?" selected":"").'>Cliente</option>';
...
<table width=100% cellpadding=3 cellspacing=3 border=0><tr><td colspan=5><b>Seleccione las columnas a desplegar:</b></td></tr>
<tr><td width=20% valign=top>
<input name="campos[]" type="checkbox" value="clave"'; 
$checa_array1=array_search("nombre",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Clave<br>
<input name="campos[]" type="checkbox" value="nombre"'; 
...
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Usuario<br>
<input name="campos[]" type="checkbox" value="uctel"'; 
$checa_array1=array_search("uctel",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Telefono<br>
<input name="campos[]" type="checkbox" value="uccel"'; 
$checa_array1=array_search("uccel",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Celular<br>
<input name="campos[]" type="checkbox" value="ucmail"'; 
$checa_array1=array_search("ucmail",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> E-mail<br>
...
<input name="campos[]" type="checkbox" value="fecha_inicio"'; 
$checa_array1=array_search("fecha_inicio",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Fecha de Inicio<br>

<input name="campos[]" type="checkbox" value="fecha_vencimiento"'; 
$checa_array1=array_search("fecha_vencimiento",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Fecha de Vencimiento<br>

<input name="campos[]" type="checkbox" value="producto"'; 
$checa_array1=array_search("producto",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Producto<br>
</td>
<td width=20% valign=top>
<input name="campos[]" type="checkbox" value="marca"'; 
$checa_array1=array_search("marca",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Marca<br>

<input name="campos[]" type="checkbox" value="modelo"'; 
$checa_array1=array_search("modelo",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Modelo<br>

<input name="campos[]" type="checkbox" value="tipo"'; 
$checa_array1=array_search("tipo",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Tipo<br>

<input name="campos[]" type="checkbox" value="color"'; 
$checa_array1=array_search("color",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Color<br>

<input name="campos[]" type="checkbox" value="placas"'; 
$checa_array1=array_search("placas",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> Placas<br>

<input name="campos[]" type="checkbox" value="serie"'; 
$checa_array1=array_search("serie",$campos);
if($checa_array1===FALSE){} else{echo' checked ';} 
echo'/> No. Serie<br>
...
$link = mysql_connect($host, $username, $pass); 
mysql_select_db($database, $link); 
$result = mysql_query("SELECT * FROM TipoCliente order by idTipoCliente", $link); 
if (mysql_num_rows($result)){ 
  while ($row = @mysql_fetch_array($result)) { 
...
$link = mysql_connect($host, $username, $pass); 
mysql_select_db($database, $link); 
$result = mysql_query("SELECT * FROM Empleado order by nombre", $link); 
if (mysql_num_rows($result)){ 
  while ($row = @mysql_fetch_array($result)) { 
  echo'<option value="'.$row["idEmpleado"].'"';
