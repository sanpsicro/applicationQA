...
$db = mysql_connect($host,$username,$pass);
mysql_select_db($database,$db);
$result = mysql_query("SELECT * from usuarios_contrato where clave = '$contrato'",$db);
if (mysql_num_rows($result)){ 
$producto=mysql_result($result,0,"productos");
}
$db = mysql_connect($host,$username,$pass);
mysql_select_db($database,$db);
$result = mysql_query("SELECT * from productos where id = '$producto'",$db);
if (mysql_num_rows($result)){ 
...
$db = mysql_connect($host,$username,$pass);
mysql_select_db($database,$db);
$result = mysql_query("SELECT * from servicios where id = '$servo'",$db);
if (mysql_num_rows($result)){ 
