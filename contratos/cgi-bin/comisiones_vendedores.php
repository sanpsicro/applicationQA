...
<table border=0 width=100% cellpadding=0 cellspacing=0>
 <tr> 
      <td height="44" align="left"><table width=100% cellpadding=0 cellspacing=0><tr><td><span class="maintitle">Comisiones a Vendedores</span></td><td width=150 class="blacklinks"><?
$checa_array1=array_search("4_a",$explota_permisos);
if($checa_array1===FALSE){} else{echo' <a href="?module=admin_contratos&accela=new"></a>';} ?></td></tr></table></td></tr>
 <tr> 
...
echo'<table width="100%" border="0" cellspacing="3" cellpadding="3">
                    ...
                    <tr> 
                     ...
                     <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Vendedor</b></td>				  	                     <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Num. Contrato</b></td>
                     <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Comision</b></td>					                     <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Status</b></td></tr>';
...
<td bgcolor="'.$bgcolor.'" class="dataclass"><center>Pagada</center></td></tr> 
