...
if (confirm("¿Est&aacute; seguro de querer eliminar \n" + name_cat + "?")) { 
...
$result=mysql_query("SELECT tipo FROM servicios,general where general.servicio=servicios.id AND general.id='$id'") or die(mysql_error());
...
<table border=0 width=100% cellpadding=0 cellspacing=0>
 <tr> 
      ...
      <td width=100 class="blacklinks"><? if($tipoServicio=="legal"){echo "<a href='?module=detail_seguimiento&id=$id'>Detalle</a> | <a href='?module=conclusion_caso&id=$id'>Conclusi�n</a>";}?></td>
...
$result = mysql_query("SELECT * FROM notas_legal where general='$id' order by fecha desc", $link); 
