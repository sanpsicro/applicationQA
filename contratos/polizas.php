 ...
 <tr> 
      ...
      <td height="47" align="left" background="img/bar5.gif"><table width="100%" border="0" cellspacing="3" cellpadding="3">
          ...
          <tr>
            ...
            <form name="form1" method="post" action="mainframe.php?module=polizas"><td align="right" class="questtitle">b&uacute;squeda: 
...
$pag = ($_GET['pag']); 
if (!isset($pag)) $pag = 1;
$result = mysql_query("SELECT COUNT(*) FROM Poliza $condicion", $link); 
...
$result = mysql_query("SELECT * FROM Poliza $condicion order by $sort  
...
echo'<table width="100%" border="0" cellspacing="0" cellpadding="0" background="img/back_main.gif">
                    ...
                    <tr> 
                      ...
                      <td background="img/bar4.gif" width=150  align=middle class="dataclass"><b>Operaci&Oacute;n</b></td></tr>';
