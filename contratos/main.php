...
<br /><br />
<div align="center"><h1>SERVICIOS EN PROCESO</h1></div>
<?
...
$prego2="SELECT general.id, general.num_contrato, general.ubicacion_municipio, general.ejecutivo, general.ubicacion_estado , general.destino_municipio, general.reporte_cliente, general.contrato, general.fecha_recepcion, general.expediente, general.usuario, general.status FROM general where general.status='abierto' AND (general.contrato LIKE '$contratiempo1$arreglobajos%' OR general.contrato LIKE '$contratiempo2$arreglobajos%' OR general.contrato LIKE '$contratiempo3$arreglobajos%' OR general.contrato LIKE '$contratiempo4$arreglobajos%' OR general.contrato LIKE '$contratiempo5$arreglobajos%') order by general.fecha_recepcion DESC";
...
<div align="center">
  <h1>SERVICIOS CONCLUIDOS EN LAS ULTIMAS 6 HORAS</h1></div>
...
$dia=date("d");
$ano=date("Y");
$timelimit=date("Y-m-d H:i:s", mktime($hora-6,$minuto,$segundo,$mes,$dia,$ano));
$pregoX="SELECT general.id, general.num_contrato, general.ubicacion_municipio, general.ejecutivo, general.ubicacion_estado, general.destino_municipio, general.reporte_cliente, general.contrato, general.fecha_recepcion, general.expediente, general.usuario, general.status, general.ultimostatus FROM general where general.status!='abierto' AND (general.contrato LIKE '$contratiempo1$arreglobajos%' OR general.contrato LIKE '$contratiempo2$arreglobajos%' OR general.contrato LIKE '$contratiempo3$arreglobajos%' OR general.contrato LIKE '$contratiempo4$arreglobajos%' OR general.contrato LIKE '$contratiempo5$arreglobajos%') AND general.ultimoseguimiento>='$timelimit' order by general.ultimoseguimiento DESC";

//echo $pregoX;
$resultX = mysql_query("$pregoX", $link) or die (mysql_error()); 
