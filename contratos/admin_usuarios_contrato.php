...
$nombre=mysql_result($result,0,"nombre");
$domicilioa=mysql_result($result,0,"calle");
$domiciliob=mysql_result($result,0,"numero");
$domicilio="$domicilioa $domiciliob";
$ciudad=mysql_result($result,0,"ciudad");
$municipio=mysql_result($result,0,"municipio");
$estado=mysql_result($result,0,"estado");
$colonia=mysql_result($result,0,"colonia");
$tel=mysql_result($result,0,"telefonoCasa");
$cel=mysql_result($result,0,"telefonoCelular");
$nextel=mysql_result($result,0,"nextel");
