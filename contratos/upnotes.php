...
$result = mysql_query("SELECT * from notas_legal where id='$idnota' and general = '$id'",$db);
...
if($caso == "nuevo"){
mysql_connect($host,$username,$pass);
mysql_db_query($database,"INSERT INTO `notas_legal` (`general`, `fecha`, `etapa`, `tipo`, `comentario`, `adjunto1`, `adjunto2`, `adjunto3`, `adjunto4`) VALUES ('$id', '$fecha_a-$fecha_m-$fecha_d', '$etapa', '$tipo', '$comentario', '$archivo1', '$archivo2', '$archivo3', '$archivo4')"); 
header("Location: mainframe.php?module=seguimiento_caso&id=$id");
}
