...
$result = mysql_query("SELECT COUNT(*) FROM servicios $condicion", $link); 
...
$result = mysql_query("SELECT * FROM servicios $condicion order by $sort  
...
echo'<table width="100%" border="0" cellspacing="3" cellpadding="3">
                    ...
                    <tr> 
                      ...
                      <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Tipo</b></td>					  
