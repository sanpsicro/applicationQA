          ...
          <tr>
            ...
            <td width="400"> 
              ...
              <select name="sort" id="ordenar">
                <option value="contrato, inciso" <? if($sort=="contrato, inciso"){echo"selected";}?>>Ordenar por N&uacute;mero de contrato</option>
...
$result = mysql_query("SELECT * from usuarios_contrato $condicion order by $sort", $link); 
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
    ...
    <td align="center" bgcolor="#bbbbbb"><strong>Operaciones</strong></td>		
  </tr>';
