...
<table border=0 width=100% cellpadding=0 cellspacing=0>
 <tr> 
      <td height="44" align="left"><table width=100% cellpadding=0 cellspacing=0><tr><td><span class="maintitle">Facturas</span></td><td width=150 class="blacklinks"><?  $checa_array1=array_search("22_a",$explota_permisos);
          ...
          <tr>
            ...
            <td width="400"> 
              ...
              <select name="sort" id="ordenar">
                ...
                <option value="facturas.status" <? if($sort=="facturas.status"){echo"selected";}?>>Ordenar por status</option>				
...
$pag = ($_GET['pag']); 
if (!isset($pag)) $pag = 1;
$result = mysql_query("SELECT COUNT(*) FROM facturas left join Cliente on (facturas.cliente = Cliente.idCliente) $condicion", $link); 
list($total) = mysql_fetch_row($result);
$tampag = $show;
$reg1 = ($pag-1) * $tampag;
$result = mysql_query("SELECT facturas.id as factid, facturas.cliente, facturas.factura, facturas.fecha, facturas.total, facturas.status as statusfactura, Cliente.nombre FROM facturas left join Cliente on (facturas.cliente = Cliente.idCliente) $condicion order by $sort  
...
echo'<table width="100%" border="0" cellspacing="3" cellpadding="3">
                    <tr> 
                      <td bgcolor="#BBBBBB" align=middle class="dataclass"><b>Factura</b></td>
