 ...
 <tr> 
      <td height="47" align="left"><table width="100%" border="0" cellspacing="3" cellpadding="3">
          <tr>
            ...
            <td>&nbsp;</td>
            <form name="form1" method="post" action="bridge.php?module=ventas"><td align="right" class="questtitle">b&uacute;squeda: 
...
echo'<table width="100%" border="0" cellspacing="3" cellpadding="3">
                    <tr> 
                     ...
                     <td bgcolor="#BBBBBB" width=150  align=middle class="dataclass"><b>Ingreso</b></td></tr>';
$bgcolor="#cccccc";
