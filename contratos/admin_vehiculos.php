  ...
  <tr>
    ...
    <td colspan="4" bgcolor="#bbbbbb"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="150" align="center" class="blacklinks">[ <a href="vehiculos.php?tmpid=<? echo $tmpid; ?>&idPoliza=<? echo $idPoliza; ?>&tipocliente=<? echo $tipocliente; ?>">Lista de veh&iacute;culos</a> ]</td>
