...
if($modulo=="cobranza"){
	...
	$query="SELECT cobranza.id, cobranza.conceptor, cobranza.monto, cobranza.status, cobranza.fecha, Cliente.nombre, general.fecha_recepcion 
...
$checa_array1=array_search("clave",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Clave", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 40); $cuenta_columnas++;} 
$checa_array1=array_search("nombre",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Nombre", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 40); $cuenta_columnas++;} 
$checa_array1=array_search("usuario",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Usuario", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("uctel",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Telefono", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("uccel",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Celular", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("ucmail",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "E-mail", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
...
$checa_array1=array_search("fecha_inicio",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Fecha de Inicio", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("fecha_vencimiento",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Fecha de Vencimiento", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("producto",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Producto", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("marca",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Marca", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("modelo",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Modelo", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("tipo",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Tipo", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("color",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Color", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("placas",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Placas", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("serie",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Serie", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
$checa_array1=array_search("servicio",$campos); if($checa_array1===FALSE){} else{$worksheet->write(0, $cuenta_columnas, "Servicio", $header); $worksheet->set_column($cuenta_columnas, $cuenta_columnas, 20); $cuenta_columnas++;}
...
$checa_array1=array_search("clave",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["clave"]); $cuenta_columnas++;}
$checa_array1=array_search("nombre",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["nombre"]); $cuenta_columnas++;}
$checa_array1=array_search("usuario",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["usuario"]); $cuenta_columnas++;}
$checa_array1=array_search("uctel",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["uctel"]); $cuenta_columnas++;}
$checa_array1=array_search("uccel",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["uccel"]); $cuenta_columnas++;}
$checa_array1=array_search("ucmail",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["ucmail"]); $cuenta_columnas++;}
...
$checa_array1=array_search("fecha_inicio",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["fecha_inicio"]); $cuenta_columnas++;}
$checa_array1=array_search("fecha_vencimiento",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["fecha_vencimiento"]); $cuenta_columnas++;}
$checa_array1=array_search("producto",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["producto"]); $cuenta_columnas++;}
$checa_array1=array_search("marca",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["marca"]); $cuenta_columnas++;}
$checa_array1=array_search("modelo",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["modelo"]); $cuenta_columnas++;}
$checa_array1=array_search("tipo",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["tipo"]); $cuenta_columnas++;}
$checa_array1=array_search("color",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["color"]); $cuenta_columnas++;}
$checa_array1=array_search("placas",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["placas"]); $cuenta_columnas++;}
$checa_array1=array_search("serie",$campos); if($checa_array1===FALSE){} else{$worksheet->write($cuenta_filas, $cuenta_columnas, $row["serie"]); $cuenta_columnas++;}
...
$checa_array1=array_search("serie",$campos); if($checa_array1===FALSE){} else{echo'<td align="center" bgcolor="#bbbbbb"><strong>No. Serie</strong></td>';}
